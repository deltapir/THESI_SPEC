...
\begin{itemize}
	...
	\item un impianto di questa estensione ha come potenze di progetto (ovvero verso l'utenza) in estate $\dot{Q}_{geo,c}=\SI{192}{kW}$ e in inverno $\dot{Q}_{geo,h}=\SI{170}{kW}$ ovvero si riesce a coprire il carico annuale del solo corpo C. 
\end{itemize}
...
Si riporta di seguito il campo sonde.

Nella sottocentrale sono state utilizzate, quindi, due pompe di calore in parallelo capaci di rendere in inverno \n{90}{kW} e \n{100}{kW} in estate: questa scelta è stata effettuata in quanto in caso di carico massimo le due macchine riescono a sfruttare tutto il campo geotermico mentre in occasione dei carichi parziali, è possibile spegnerne una e lavorare sempre a pieno carico. 

\texttt{Si tiene a precisare che mentre assorbitore e scambiatore procudono soltanto freddo la pompa di calore fa il caldo in inverno. È necessario costruire opportunamente la sottocentrale in modo tale da fornire il caldo in inverno nonostante assorbitore e scambiatore funzionino in freddo.}

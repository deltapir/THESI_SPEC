...
\begin{center}
	...
	\vspace{3em}
	{\Large
	\textsc{ elaborato di laurea in}\\\textsc{riqualificazione energetica di edifici ospedalieri:\vspace{0.3em}\\analisi progettuale relativa all'edificio 2 dell'AOU~``Federico II''}}\\
	\vspace{5em}

...
È necessario a questo punto elementi di costruzione di un edificio poco energivoro.

\subsubsection{Stagione Invernale}
Le ipotesi di \emph{regime stazionario} semplifica di molto la stima del carico termico. Anche la scelta dei materiali dell'involucro non è impegnativa. Si cerca, infatti, di avere una trasmittanza tale da contenere la potenza termica entrante. Si agisce essenzialmente sulla $U$. Al giorno d'oggi il Decreto Ministeriale del 26 Giugno 2015 chiede di contenere questi valori di trasmittanza entro quelli riportati nella seguente tabella valida per le strutture opache verticali soggette a riqualificazione:
\begin{center}
	\begin{tabular}{ccc}
...
Bisogna spendere qualche parola sui componenti trasparenti.
...
Quelli dedicati alla stagione invernale risultano essere quanto più trasparenti possibili alla radiazione solare (sopratutto sulle lunghezza d'onda del visibile) ma opachi sull'infrarosso.
...
I vetri a \emph{controllo solare} sono stati sviluppati per proteggere l'ambiente interno dalla radiazione solare. Essi comprendono:
\begin{itemize}

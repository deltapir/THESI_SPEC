...
Dopo aver definito il comfort in un ambiente, è necessario calcolare il carico termico (ovvero la potenza termica entrante o uscente da un ambiente) per poi progettare l'impianto che permetta di realizzare quelle condizioni termicamente accettabili.

Con \emph{carico termico} si definisce una potenza che sollecita termicamente un edificio allontanando le condizioni 
%====================================
\vspace{2cm}

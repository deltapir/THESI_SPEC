...
Per la zona termica \textbf{Radiatori} è ovvio che il carico sia nullo.

Il carico latente è definito come:
\begin{equation}
	\label{carico:latente}
	Q_L=Q_{vent,L}+Q_{int,L}
\end{equation}
mentre il carico sensibile
\begin{equation}
	\label{carico:sensibile}
	Q_S=Q_{sol}+Q
\end{equation}
Per il V Piano, UTIC e Emodinamica

...
\begin{table}
		...
		\begin{tabular}{lccccc}
			\toprule
			\multirow{2}*{Zona Termica} & Superficie 		& Ventilazione 					& $\dot{Q}_L$ 			& $\dot{Q}_S$ 					& $\dot{Q}_{frigo}$  \\
...
\begin{table}
	...
	\begin{tabular}{lcccc}
		\toprule
		\multirow{2}*{Zona Termica} & Superficie 		& Ventilazione 					& $\dot{Q}_{trasm}$ 	 			& $\dot{Q}_{riscc}$		\\

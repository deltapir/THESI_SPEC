...
Riferendosi alla sola centrale termica del policlinico, l'acqua surriscaldata viene prodotta a \n{130}{\degreeCelsius} e non più a \n{170}{\degreeCelsius}. Il cogeneratore a gas metano è da \n{5.5}{MW_e} e \n{9}{MW_t} con caldaia a recupero. I reflui termici alimentano da un lato la rete di teleriscaldamento e dall'altra un gruppo di assorbitori bistadio che a loro volta servono la rete di teleraffrescamento. Un'altra modifica che ha interessato la centrale termica è stata la sostituzione delle torri evaporative giustificata da costi di manutenzione eccessivi e usura evidente della struttura portante. Basti pensare che quelle originali erano in legno il quale è stato sottoposto giornalmente (e per tutti questi \num{50} anni) a cicli di umidificazione e deumidificazione (per il loro funzionamento normale) e non bisogna dimenticare la variabilità delle condizioni climatiche esterne (oltre a tutti gli agenti inquinanti atmosferici).
...
Si riportano inizialmente i dati della potenza elete
...
\begin{center}
		...
		\begin{tabular}{lccccc}
			\toprule
			\multirow{2}*{Zona Termica} & Superficie 		& Ventilazione 					& $Q_L$ 			& $Q_S$ 					& $\dot{Q}_{frigo}$  \\
